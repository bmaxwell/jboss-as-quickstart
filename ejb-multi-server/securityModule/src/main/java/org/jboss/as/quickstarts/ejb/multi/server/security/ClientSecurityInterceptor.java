 ...
 */
package org.jboss.as.quickstarts.ejb.multi.server.security;
...
public class ClientSecurityInterceptor implements EJBClientInterceptor {
    private static final Logger logger = Logger.getLogger(ClientSecurityInterceptor.class);
    ...
    public void handleInvocation(EJBClientInvocationContext context) throws Exception {
        ...
        if (currentPrincipal != null) {
            ...
            logger.info("Security context set, user " + currentPrincipal.getName());
